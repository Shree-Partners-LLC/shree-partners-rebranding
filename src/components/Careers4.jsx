...
const Careers4 = ({
  ...
  return (
    <section
      id="apply"
      ref={sectionRef}
      className="application-section scroll-animation"
    >
      <div className="container application-container">
        <span className="section-tag blue">Apply Now</span>
        <h2>Submit your application</h2>
        <p className="application-text">
          Don't see a perfect fit? Choose "General application" and tell us what
          you do best.
        </p>
        <div className="application-card">
          {!submitted ? (
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                ...
                <textarea
                  rows="5"
                  name="note"
                  placeholder="Tell us what you'd bring and what you're looking for..."
                ></textarea>
              </div>
              <div className="checkbox-group">
                <input type="checkbox" id="consent" required />
                <label htmlFor="consent">
                  I consent to Shree Partners storing my information for
            ...
            <div className="success-box">
              ...
              <p>
                We've got your application for the{" "}
