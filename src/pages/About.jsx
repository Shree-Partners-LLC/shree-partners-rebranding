  ...
  <div className="about-container">
    ...
    <div className="about-left">
      ...
      <p>
        ...
        embedding agentic automation and machine learning into the core
        of how our clients operate.
      </p>
  ...
  <div className="mission-container">
    ...
    <div className="mission-right">
      ...
      <p>
        ...
        where it counts. We bring the engineering discipline,
        governance, and industry depth to change that — so AI becomes
        an operating advantage, not a science project.
      </p>
  ...
  <div className="values-container">
    ...
    <div className="values-grid">
      ...
      <div className="value-card">
        ...
        <p>
          We measure success in business results, not slideware or
          shipped tickets.
        </p>
      ...
      <div className="value-card">
        ...
        <p>
          We embed with your teams and leave them stronger than we
          found them.
        </p>
...
<section className="leadership">
  ...
  <div className="leadership-container">
    ...
    <p className="leadership-text">
      Drop in headshots and update names — these are placeholders ready to edit.
    </p>
    ...
    <div className="leadership-grid">
      ...
      <div className="leader-card">
        ...
        <p>
          Sets the vision and steers the firm's AI-first strategy.
        </p>
      ...
      <div className="leader-card">
        ...
        <p>
          Leads client relationships and global delivery operations.
        </p>
      ...
      <div className="leader-card">
        ...
        <p>
          Owns the AI practice, research direction and engineering standards.
        </p>
