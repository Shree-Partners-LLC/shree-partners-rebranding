    ...
    <div className="healthcare">
      ...
      <section className="healthcare-intro">
        <div className="healthcare-content">
          <div className="healthcare-text">
            <p>
              The healthcare industry is on a continuous quest to improve
              patient experience, optimize health outcomes, and reduce costs
              while ensuring regulatory compliance.
            </p>
            <p>
              Shree Partners helps you grow your business by leveraging emerging
              technologies and industry best practices that lead to successful
              outcomes.
            </p>
          ...
          <div className="healthcare-image">
            <img src={introImg} alt="Healthcare Industry" />
          </div>
        </div>
      </section>
      <section className="segments">
        ...
        <div className="segment-grid">
          <Link to="/industries/healthcare/payer" className="segment-card">
          ...
          <Link to="/industries/healthcare/provider" className="segment-card">
          ...
          <Link to="/industries/healthcare/pharma" className="segment-card">
      ...
      <section className="offerings">
        ...
        <div className="offer-grid">
          <div className="offer-card">
            ...
            <p>
              HIPAA, HL7, PHI and CFR compliance solutions that ensure secure
          ...
          <div className="offer-card">
            ...
            <p>
              Modern patient care through cloud,mobility and analytics
              solutions.
            </p>
          </div>
          <div className="offer-card">
            ...
            <p>
              Improve engagement, gain insights and enhance operational
              efficiency.
            </p>
          </div>
          <div className="offer-card">
            ...
            <p>
              Secure healthcare data management and information exchange
              systems.
            </p>
          </div>
          <div className="offer-card">
      ...
      <section className="business-value">
        ...
        <div className="business-wrapper">
          <div className="business-card">
            ...
            <ul>
              <li>
                <strong>Increase</strong> patient care and engagement through
                mobile platforms and automation.
              </li>
              <li>
                <strong>Enhance</strong> operational efficiencies through
                integrated technology solutions.
              </li>
              <li>
                <strong>Improve</strong> business results using analytics-driven
                insights.
              </li>
              <li>
                <strong>Grow</strong> revenue through innovative healthcare
